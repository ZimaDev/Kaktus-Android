...
public class RatingDialog extends AppCompatDialog implements RatingBar.OnRatingBarChangeListener, View.OnClickListener {
    ...
    public RatingDialog(Context context, int theme, Builder builder) {
        super(context, theme);
        this.context = context;
        this.builder = builder;
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.dialog_rating_button_negative) {
            ...
            if (builder.ratingDialogFormListener != null) {
                builder.ratingDialogFormListener.onFormSubmitted(feedback, currentRate);
            }
    ...
    public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
        ...
        if (ratingBar.getRating() >= threshold) {
            ...
            if (builder.ratingThresholdClearedListener == null) {
                addDefaultRatingThresholdClearedListener();
            }
            for (Builder.RatingThresholdClearedListener listener : builder.ratingThresholdClearedListenerList) {
                listener.onThresholdCleared(this, ratingBar.getRating(), thresholdPassed);
            }
    ...
    private void addDefaultRatingThresholdClearedListener() {
        builder.ratingThresholdClearedListenerList.add(new Builder.RatingThresholdClearedListener() {
            @Override
    ...
    private void openPlaystore(Context context) {
        ...
        try {
            ...
            new StyleableToast
                    .Builder(context, "Пожалуйста, оставьте оценку в Play Market")
                    .withBackgroundColor(context.getResources().getColor(R.color.kaktus_green))
                    .withDuration(Toast.LENGTH_LONG)
                    .build()
                    .show();
        } catch (android.content.ActivityNotFoundException ex) {
            new StyleableToast
                    .Builder(context, "Play Маркет не найден")
                    .withBackgroundColor(context.getResources().getColor(R.color.kaktus_green))
    ...
    public void showNever(boolean needShowNever) {
        sharedpreferences = context.getSharedPreferences(MyPrefs, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedpreferences.edit();
        editor.putBoolean(SHOW_NEVER, needShowNever);
        editor.commit();
    }
    ...
    public static class Builder {
        ...
        private ArrayList<RatingThresholdClearedListener> ratingThresholdClearedListenerList = new ArrayList<>();
        ...
        public Builder setOnThresholdCleared(RatingThresholdClearedListener ratingThresholdClearedListener) {
            this.ratingThresholdClearedListener = ratingThresholdClearedListener;
            return this;
        }

        public Builder addOnThresholdCleared(RatingThresholdClearedListener ratingThresholdClearedListener) {
            ratingThresholdClearedListenerList.add(ratingThresholdClearedListener);
            return this;
        }
        ...
        public RatingDialog build() {
            if (theme == 0) return new RatingDialog(context, this);
            else return new RatingDialog(context, theme, this);
        }
    }
}
